...
## New Feature Request
- **Objective:** Have a new main entry in the system called Health and other for the Workout options
- **Key Details:**
  - Cretate a new main menu entry called "Health"
  - Cretate a new main menu entry called "Workout"
  - Move all the functionality already implemented under "Workout" main menu
  - Inside "Health" move the functionality related to Weight tracking (Now it is under profile) 
